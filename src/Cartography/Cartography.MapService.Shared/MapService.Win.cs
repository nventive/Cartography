...
namespace Cartography.MapService
{
    ...
    /// </summary>
    public class MapServiceWin : IMapService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MapServiceWin"/> class.
        /// </summary>
        /// <param name="dispatcherScheduler">Dispatcher</param>
        /// <param name="locationService">Location service</param>
        /// <param name="logger">logger</param>
        public MapServiceWin(IDispatcherScheduler dispatcherScheduler, IGeolocatorService locationService, ILogger logger = null)
        {
