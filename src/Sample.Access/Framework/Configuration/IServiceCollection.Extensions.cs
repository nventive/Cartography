...
/// </summary>
/// <remarks>
/// Note that the class name starts with "Sample" to avoid potential collisions since we use the original namespace of <see cref="IServiceCollection"/>.
/// </remarks>
public static class SampleServiceCollectionExtensions
{
	...
	/// (see <see cref="SampleConfigurationExtensions.DefaultOptionsName(Type)"/>.
	/// </param>
