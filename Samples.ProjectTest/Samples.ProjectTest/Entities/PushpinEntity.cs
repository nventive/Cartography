...
namespace Samples.ProjectTest.Entities
{
	public class PushpinEntity : IGeoLocated
	{
		...
		public override int GetHashCode() {
			if (Coordinates == null) 
			{
				throw new InvalidOperationException("You must declare Coordinates first.");
			} 
		...
		public override bool Equals(object? obj)
		{
			...
			if (obj != null && other != null && other.Coordinates != null)
			{
